...
<a href="{{route('proveedores.create')}}" class="btn btn-success mb-3">Registrar Proveedor</a>
            ...
            <tr>
                ...
                <td>
                    ...
                    <form action="{{route('proveedores.destroy', $proveedores->id)}}" method="POST">
                        <a href="{{route('proveedores.edit', $proveedores->id)}}" class="btn btn-info">Editar</a>
                        @csrf
                        @method('DELETE')
